...
public class TrainingHistoryService {
	...
	public TrainingHistory napravi(Trening trening, @Context HttpServletRequest request) {
	...
	@Path("/search")
	@Produces(MediaType.APPLICATION_JSON)
	public ArrayList<TrainingHistory> search(@QueryParam("searchObjekat") String searchObjekat, @QueryParam("pocetno") String pocetno, 
